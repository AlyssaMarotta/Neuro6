    ...
    <div>
      ...
      <Switch>
        ...
        <PrivateRoute
          ...
          path='/NewAppointment'
          email={account}
          component={() => <NewAppointment email={account} />}
        />
        <PrivateRoute
          exact
          path='/NewAppointmentAdmin'
          component={() => <NewAppointmentAdmin />}
        />
        ...
        <PrivateRoute
          ...
          component={(matchProps) => (
            <Appointment email={account} {...matchProps} {...props} />
          )}
        />
